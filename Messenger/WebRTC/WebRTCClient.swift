...
//            startCaptureLocalVideo(cameraPositon: self.cameraDevicePosition, videoWidth: 640, videoHeight: 640*16/9, videoFps: 30)
            startCaptureLocalVideo(cameraPositon: self.cameraDevicePosition, videoWidth: 1280, videoHeight: 720, videoFps: 30)
...
//                self.startCaptureLocalVideo(cameraPositon: self.cameraDevicePosition, videoWidth: 192, videoHeight: 144, videoFps: 60)
                self.startCaptureLocalVideo(cameraPositon: self.cameraDevicePosition, videoWidth: 1280, videoHeight: 720, videoFps: 30)
            }
...
//            , RTCIceServer(urlStrings: ["turn:numb.viagenie.ca:3478"], username: "sudosuwal@gmail.com", credential: "passkeys123")
//            , RTCIceServer(urlStrings: ["turn:13.127.201.188:3478"], username: "sudosuwal@gmail.com", credential: "passkeys123")
        rtcConf.iceServers = [RTCIceServer(urlStrings: ["turn:numb.viagenie.ca:3478"], username: "sudosuwal@gmail.com", credential: "passkeys123")]
//        RTCIceServer(urlStrings: ["stun:stun.l.google.com:19302"]), RTCIceServer(urlStrings: ["stun:stun.stunprotocol.org:3478"]), 
//        rtcConf.iceServers = [RTCIceServer(urlStrings: ["stun:stun.l.google.com:19302"])]
        
//        rtcConf.iceServers = [RTCIceServer(urlStrings: ["turn:192.168.31.226:3478"], username: "sudayn", credential: "passkeys123")]
